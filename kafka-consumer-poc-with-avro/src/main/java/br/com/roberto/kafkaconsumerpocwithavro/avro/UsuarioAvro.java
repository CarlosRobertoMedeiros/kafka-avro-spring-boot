 ...
 */
package br.com.roberto.kafkaconsumerpocwithavro.avro;
...
public class UsuarioAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder newBuilder() {
    return new br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder();
  }
   ...
   * @return A new UsuarioAvro RecordBuilder
   */
  public static br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder newBuilder(br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder other) {
    if (other == null) {
      return new br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder();
    } else {
      return new br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder(other);
    }
  }
   ...
   * @return A new UsuarioAvro RecordBuilder
   */
  public static br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder newBuilder(br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro other) {
    if (other == null) {
      return new br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder();
    } else {
      return new br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UsuarioAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.nome)) {
        this.nome = data().deepCopy(fields()[0].schema(), other.nome);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder setNome(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder clearNome() {
      nome = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder setEndereco(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder clearEndereco() {
      endereco = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder setIdade(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.roberto.kafkaconsumerpocwithavro.avro.UsuarioAvro.Builder clearIdade() {
